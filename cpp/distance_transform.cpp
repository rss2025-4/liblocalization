// taken from
// https://github.com/Sebastian-Garcia/racecar_simulator/blob/0e20c77dcc408c7b4babf153ef3baeadf5448ce8/src/distance_transform.cpp
...
void distance_squared_1d(const std::vector<double> &input,
  ...
  for (size_t idx = 0; idx < input.size(); idx++) {
    ...
    while (parabola_boundaries[parabola + 1] < idx)
      parabola++;
...
void distance_squared_2d(std::vector<double> &input, size_t width,
                         size_t height, double boundary_value) {
